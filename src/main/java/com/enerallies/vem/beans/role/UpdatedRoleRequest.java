...
/**
 * File Name : UpdatedRoleRequest 
 * 
 * UpdatedRoleRequest: is used to hold the update role request data from client.
 *
 ...
 * 
 * DATE				USER             	COMMENTS
 * 10-08-2016		Goush Basha		    File Created.
 * 30-08-2016       Goush Basha			Sprint-2 Suggestions/Changes.
 * 
 */

@JsonIgnoreProperties(ignoreUnknown=true)
public class UpdatedRoleRequest {
